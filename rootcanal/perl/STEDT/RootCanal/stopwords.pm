package STEDT::RootCanal::stopwords;
use strict;
our @ISA = qw(Exporter);
our @EXPORT = qw(mysql_fulltext_filter);

# mysql's fulltext search ignores certain words in its "stopwords" list.
# it also ignores words that are shorter than a certain length (default is 4).
# this module is a quick and dirty utility to separate these out.
...
"inasmuch", "inc", "indeed", "indicate", "indicated", "indicates", "inner",
"insofar", "instead", "into", "inward", "is", "isn't", "it", "it'd", "it'll",
"it's", "its", "itself", "just", "keep", "keeps", "kept", "know", "known",
"knows", "last", "lately", "later", "latter", "latterly", "least", "less",
"lest", "let", "let's", "like", "liked", "likely", "little", "look", "looking",
...
"please", "plus", "possible", "presumably", "probably", "provides", "que",
"quite", "qv", "rather", "rd", "re", "really", "reasonably", "regarding",
"regardless", "regards", "relatively", "respectively", "right", "said", "same",
"saw", "say", "saying", "says", "second", "secondly", "see", "seeing", "seem",
...
"would", "wouldn't", "yes", "yet", "you", "you'd", "you'll", "you're", "you've",
"your", "yours", "yourself", "yourselves", "zero");
my %is_stopword;
@is_stopword{@stopwords} = (1) x @stopwords;
