...
def opendb(options):
    ...
    try:
        ...
        #options.db = MySQLdb.connect(passwd="l0l0ish", user="stedtuser", host="192.168.100.222", db="stedt")
...
def renderform(params,actiontype):
    ...
    #<form action="http://localhost/cgi-bin/morph2.py" method="get">

    formstart = """
         <form action="http://localhost/cgi-bin/morph2.py" method="post">
    ...
    if actiontype == "syllable":
        ...
        fields = ("morpheme","tag","initial","rhyme","tone","gloss")
